function centrifugalpump(Q, p, SG, Psg, Pdg, Pv) {
    ...
    console.log("Differential Pressure:", Pdiff, "kg/cm2");
    console.log("Hydraulic Power:", phydraulic, "kW");
    console.log("Efficiency:", efficiency, "%");
    console.log("Differential head:", Diffhead, "m");
    console.log("NPSH:", NPSH, "m");
    return [Diffhead, phydraulic, efficiency, NPSH];
  }
  
  console.log("Design efficiency of P10", centrifugalpump(200.4, 112.58, 0.52, 6.8, 19.8, 7.6));
  console.log("Normal efficiency of P10", centrifugalpump(167, 112.58, 0.52, 6.8, 19.8, 7.6));
  console.log("Design efficiency of P202", centrifugalpump(266.1, 238, 0.61, 0.881, 22.981, 1.64));
  console.log("Design efficiency of P202", centrifugalpump(241, 238, 0.61, 0.881, 22.981, 1.64));  